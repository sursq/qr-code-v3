...
Vercel يشغّل التطبيق في بيئة **serverless** نظام ملفاتها مؤقّت وللقراءة فقط، لذلك **لن تُحفظ البيانات أو الملفات** على Vercel بالاعتماد على التخزين الملفّي الحالي (ستُفقد عند كل تشغيل/نشر). هذا قيد في منصّة Vercel نفسها وليس خطأً في النظام.

للنشر على Vercel تحديداً، يلزم استبدال التخزين الملفّي بخدمات سحابية:
